...
def update_my_positions():
    try:
        ...
        # Получаем объект должности "Администратор"
        ...
        # Текущие должности пользователя
        ...
        # === ЗАЩИТА ОТ ВЫДАЧИ АДМИНА НЕ-АДМИНУ ===
        ...
        # Валидация: все запрошенные должности существуют
        ...
        # Добавляем новые (кроме запрещённых случаев — уже отфильтровано выше)
